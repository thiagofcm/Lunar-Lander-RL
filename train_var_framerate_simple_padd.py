...
if __name__ == "__main__":
    ...
    for frame_cost in frame_cost_grid:
        ...
        model_dir = f"lunar_lander_models/var_framerate/simple_padd/landing_penalty_{LANDING_PENALTY}/{current_time}_FPS_{frame_cost_str}"
        ...
        # Training Settings:
        env = make_vec_env("LunarLander_VarFramerate_SimplePadded", n_envs=N_ENV, env_kwargs={"frame_cost": frame_cost, "max_episode_steps": 500})
        ...
        # Start Evaluation
        eval_env = gym.make("LunarLander_VarFramerate_SimplePadded", frame_cost=frame_cost)
